...
$jumlah_barang=mysqli_num_rows(mysqli_query($koneksi,'SELECT * FROM tb_barang where id'));
$jumlah_transaksi=mysqli_num_rows(mysqli_query($koneksi,'SELECT * FROM transaksi_pembelian where id_transaksi'));
$query = mysqli_query($koneksi, "SELECT * FROM detail_transaksi INNER JOIN transaksi_pembelian ON transaksi_pembelian.kode_transaksi=detail_transaksi.kode_transaksi INNER JOIN daftar_menu ON daftar_menu.kode_menu=detail_transaksi.kode_menu");
$total = 0;
