...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg" style="font-family: sacramento;">Cafe & Resto</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>Manajemen Aplikasi</p>
          <!-- Status -->
          <a href="#"><i class="fa fa-dot-circle-o"></i>&nbsp;</i><?php echo $data[0] ?></a>
        </div>
      </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">MASTER KASIR</li>
        ...
        <li class="#"><a href="?menu=kategori"><i class="fa fa-folder"></i> <span>Kategori</span></a></li>
        <li class="#"><a href="?menu=daftar_menu"><i class="fa fa-folder"></i> <span>Daftar Menu</span></a></li>
        <li class="#"><a href="#"><i class="fa fa-file"></i> <span>Cetak Struk</span></a></li>
        <li class="#"><a href="?menu=laporan"><i class="fa fa-book"></i> <span>Buku Laporan Transaksi</span></a></li>
      </ul>
       <ul class="sidebar-menu" data-widget="tree">
        <li class="header">MASTER ADMIN</li>
        <li class="#"><a href="?menu=barang"><i class="fa fa-plus"></i> <span>Stok Barang</span></a></li>
        <li class="#"><a href="?menu=pengurangan_stok"><i class="fa fa-minus"></i> <span>Pengurangan Stok</span></a></li>
      <!-- /.sidebar-menu -->
    </section>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 style="font-family: ELEGANT TYPEWRITER;">
        Dashboard
        <small>Aplikasi Cafe</small>
      </h1>
      <ol class="breadcrumb">
      ...
      <!--------------------------
        ...
        -------------------------->
            ...
            case 'daftar_menu':
                ...
                break;
            case 'pengurangan_stok':
                include("pengurangan_stok.php");
                break;
  ...
  <footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
      By : Creative Multimedia
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020 <a href="#">Aplikasi Cafe</a>.</strong> All rights reserved.
  </footer>
